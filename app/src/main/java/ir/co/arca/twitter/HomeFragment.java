...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        new ApiService(Objects.requireNonNull(getContext())).getTweets(new ApiService.OnTweetsReceived() {
            @Override
            public void onSuccess(List<Tweet> tweets) {
                setupNewTweet(view);
                setupProfile(view);
                //   setupOtherProfile(view);
                setupRecyclerView(view,tweets);
            }
    ...
    private void setupRecyclerView(View view,List<Tweet> tweets) {
        recyclerView = view.findViewById(R.id.homeRecyclerView);
        twitteViewAdapter = new TwitteViewAdapter<RecyclerView.ViewHolder>(tweets, getContext());
